...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/31 22:13:36 by mel-akhd          #+#    #+#             */
/*   Updated: 2024/01/31 23:13:51 by mel-akhd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	cd(t_input cmd, t_data *data)
{
	...
	{
		newdir = get_value_from_env("HOME", data->env_list);
		if (!newdir)
		{
